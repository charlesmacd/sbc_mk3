...
#-------------------------------------------------------------------------------
                ...
                .global comms_check_dispatch

USB_FLAG_RXE            =       0x80
USB_FLAG_TXF            =       0x40
USB_POLLING_ENABLED     =       1
                ...
                .macro  ugetb   dstreg
                .if     USB_POLLING_ENABLED                
        1:      move.b  (USB_STATUS).w, d7
                andi.b  #USB_FLAG_RXE, d7
                cmpi.b  #USB_FLAG_RXE, d7
                beq.s   1b
                .endif
                ...
                .if     USB_POLLING_ENABLED                
        1:      move.b  (USB_STATUS).w, d7
                andi.b  #USB_FLAG_TXF, d7
                cmpi.b  #USB_FLAG_TXF, d7
                beq.s   1b
                .endif
